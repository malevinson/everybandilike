...
var paths = {
  js: ['front/src/app.js', 'front/src/**/*.module.js', 'front/src/**/*.js'],
  libs: [
...
gulp.task('copy-images', function () {
  return gulp.src('front/assets/images/**/*.*').pipe(gulp.dest('front/dist/images/'));
});

gulp.task('copy-css', function () {
  return gulp.src('front/assets/styles/style-css/**/*.*').pipe(gulp.dest('front/dist/css/'));
});
